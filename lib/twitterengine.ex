defmodule Twitterengine do
  ...
  def start_simulation(no_of_clients, list_of_static_hashtags, active_users, list_of_socket_ids) do
    ...
    [active_users, new_active_users] = Twitterengine.maintain_connect_disconnect(no_of_clients, active_users, list_of_socket_ids)
    Process.sleep(500)
  ...
  def main(args) do  
    ...
    list_of_static_hashtags = ["#uf","gatorsnothaters","helloworld","#uffootball","#ufbasketball","#gogators"]
    ...
    list_of_socket_ids = for n <- 1..no_of_clients do
      ...
      {:ok, socket} = connect(TwitterengineWeb.UserSocket, %{})
    ...
    # Subscribe all users
    subscribe_all_user = Twitterengine.subscribe_all_user(no_of_clients, list_of_socket_ids)
